...
import my_package.algorithms.apply_hunting as apply_hunting
import my_package.algorithms.apply_time_offset as apply_time_offset
...
def apply_fault_label_statistics(data):
    ...
    # 데이터 적재
    load_database(group,'tc_ai_fault_group')
...
def apply_fault_algorithms(data):
    ...
    # 8. 자동 적재
    load_database(sensor_data,'tc_ai_fault_label')
