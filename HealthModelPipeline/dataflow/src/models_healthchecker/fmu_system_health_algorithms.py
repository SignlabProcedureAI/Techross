...
def apply_system_health_statistics_with_fmu(data):
    ...
    fmu_model_relative_path = os.path.join(current_dir,".." , "models_model","fmu_model")
    # 상대 경로를 절대 경로로 변환
    ...
    # 학습 데이터 적재
    load_database('ecs_test','tc_ai_fmu_system_health_group_v0.0.0', group)
    ...
    # 뷰 데이터 적재
    load_database('ecs_test','tc_ai_fmu_model_system_health_group_v0.0.0', group)
