...
def apply_system_health_statistics_with_fts(data):
    ...
    fts_model_relative_path = os.path.join(current_dir,".." , "model","fts_model")
    # 상대 경로를 절대 경로로 변환
    ...
    # 5. 데이터 적재
    load_database(group,'tc_ai_fts_model_system_health_group')
...
def apply_system_health_algorithms_with_fts(data):
    ...
    # 5. 자동 적재
    # load_database(system_data_condition,'test_tc_ai_fts_system_health')
