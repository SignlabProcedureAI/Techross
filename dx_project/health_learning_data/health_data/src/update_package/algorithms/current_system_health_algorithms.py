...
def apply_system_health_statistics_with_current(data):
    ...
    ecu_model_relative_path = os.path.join(current_dir,".." , "model","ecu_model")
    # 상대 경로를 절대 경로로 변환
    ...
    # 데이터 적재
    load_database(group,'tc_ai_electrode_model_group')
...
def apply_system_health_algorithms_with_current(data):
    ...
    # 6. 자동 적재
    # load_database(system_data_condition,'test_tc_ai_current_system_health')
